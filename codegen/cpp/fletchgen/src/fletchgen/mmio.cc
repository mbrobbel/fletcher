...
static std::string ToString(MmioReg::Behavior behavior) {
  switch (behavior) {
    case MmioReg::Behavior::STATUS: return "status";
    case MmioReg::Behavior::STROBE: return "strobe";
    default: return "control";
  }
}

static Port::Dir ToDir(MmioReg::Behavior behavior) {
  switch (behavior) {
    case MmioReg::Behavior::STATUS: return Port::Dir::IN;
    case MmioReg::Behavior::STROBE: return Port::Dir::OUT;
